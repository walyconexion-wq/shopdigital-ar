...
const GlobalHomePage: React.FC = () => {
    ...
    return (
        ...
        >
            ...
            {isDayMode ? (
                <div className="w-full max-w-md mx-auto min-h-screen flex flex-col items-center justify-between p-3 sm:p-5 pt-3 pb-4 sm:justify-center relative z-10">

                    {/* ── Único Contenedor Neumórfico Crema HD Unificado (Estirado Armónico) ── */}
                    <div className="neu-plate w-full flex flex-col items-center justify-between flex-1 my-auto gap-3.5 sm:gap-4 relative z-10 shadow-[0_15px_40px_rgba(30,10,60,0.35)] py-4 sm:py-5 px-3.5 sm:px-5">
                        ...
                        <div className="grid grid-cols-3 gap-2.5 w-full px-0.5">
                            {[
                                ...
                                return (
                                    <button
                                        ...
                                        className={`py-3 px-1 text-[8px] font-extrabold uppercase tracking-wider flex items-center justify-center gap-1 text-center transition-all ${
                            ...
                            {localitiesForActiveRegion.map(loc => {
                                ...
                                return (
                                    <button
                                        ...
                                        className="neu-btn-3d py-2.5 px-1 text-[7.5px] leading-tight font-extrabold uppercase tracking-wider flex items-center justify-center gap-1 text-center transition-all"
                                    >
                                        <span>
                        ...
                        {/* ── Avatar Central Animado 3D (Escalado simétrico de cuerpo entero) ── */}
                        <div className="flex flex-col items-center justify-center flex-1 relative z-0 select-none pointer-events-none my-1 py-1">
                            <div className="ari-3d-avatar-container flex flex-col items-center justify-center max-h-[220px] sm:max-h-[260px]">
                                <img
                                    src="/ari-saludando.gif"
                                    alt="ARI Asistente Animado"
                                    className="max-h-[210px] sm:max-h-[250px] h-auto w-auto object-contain filter drop-shadow-[0_8px_20px_rgba(40,10,80,0.22)]"
                                    loading="eager"
                                />
                        ...
                        <footer className="w-full z-10 pt-1 mt-auto">
                            <div className="neu-inset-title flex items-center justify-between w-full py-2.5 px-4 sm:py-3 sm:px-6">
                                <p
                                    onClick={handleCopyrightClick}
                                    className="text-[8px] font-extrabold uppercase tracking-[0.2em] text-[#2c2440] cursor-pointer select-none active:opacity-100 transition-opacity"
                                >
                                    © 2026 · SHOPDIGITAL
                                </p>
