...
const GlobalHomePage: React.FC = () => {
    ...
    return (
        ...
        >
            ...
            {isDayMode ? (
                <div className="w-full max-w-md mx-auto h-screen min-h-[100dvh] flex flex-col items-center justify-between p-2.5 sm:p-4 pt-2 pb-2 relative z-10 overflow-hidden">

                    {/* ── Único Contenedor Neumórfico Crema HD Unificado (Ajustado a Pantalla Móvil) ── */}
                    <div className="neu-plate w-full h-full flex flex-col items-center justify-between gap-2 sm:gap-3 relative z-10 shadow-[0_15px_40px_rgba(30,10,60,0.35)] py-3 sm:py-4 px-3 sm:px-5 overflow-hidden">
                        {/* ── Título Interno Hundido (Inset Neumórfico) ── */}
                        <div className="neu-inset-title py-2 px-5 text-center w-full max-w-[280px] mx-auto flex flex-col items-center justify-center flex-shrink-0">
                            <h1 className="text-[17px] font-[900] uppercase tracking-[0.1em] text-[#2c2440] select-none leading-none">
                                SHOPDIGITAL
                            </h1>
                            <div className="flex items-center justify-center gap-1 mt-0.5 select-none">
                                <span className="text-[7.5px] font-bold uppercase tracking-[0.18em] text-[#4a3d6a]">
                        ...
                        <div className="grid grid-cols-3 gap-2 w-full px-0.5 flex-shrink-0">
                            {[
                                { id: 'buenos-aires' as const, label: 'BUENOS AIRES', icon: null },
                                { id: 'cordoba' as const, label: 'CÓRDOBA', icon: null },
                                { id: 'patagonia' as const, label: 'PATAGONIA', icon: <Mountain size={12} className="opacity-70 flex-shrink-0" /> }
                            ].map(reg => {
                                ...
                                return (
                                    <button
                                        ...
                                        className={`py-2 px-1 text-[7.5px] font-extrabold uppercase tracking-wider flex items-center justify-center gap-1 text-center transition-all ${
                            ...
                            {localitiesForActiveRegion.map(loc => {
                                ...
                                return (
                                    <button
                                        ...
                                        className="neu-btn-3d py-2 px-1 text-[7px] leading-tight font-extrabold uppercase tracking-wider flex items-center justify-center gap-1 text-center transition-all"
                                    >
                                        <span>
                        ...
                        {/* ── Avatar Central Animado 3D (Subido y Escalado para Encajar Perfecto) ── */}
                        <div className="flex flex-col items-center justify-center flex-1 relative z-0 select-none pointer-events-none my-0 py-0 overflow-hidden">
                            <div className="ari-3d-avatar-container flex flex-col items-center justify-center max-h-[160px] sm:max-h-[220px]">
                                <img
                                    src="/ari-saludando.gif"
                                    alt="ARI Asistente Animado"
                                    className="max-h-[150px] sm:max-h-[210px] h-auto w-auto object-contain filter drop-shadow-[0_6px_16px_rgba(40,10,80,0.2)]"
                                    loading="eager"
                                />
                                <div className="ari-3d-shadow mt-0.5 opacity-35" />
                            </div>
                        </div>

                        {/* ── Pie de Página Neumórfico Integrado (Visible 100% en Pantalla) ── */}
                        <footer className="w-full z-10 pt-0.5 flex-shrink-0">
                            <div className="neu-inset-title flex items-center justify-between w-full py-2 px-3 sm:py-2.5 sm:px-5">
                                <p
                                    onClick={handleCopyrightClick}
                                    className="text-[7.5px] font-extrabold uppercase tracking-[0.18em] text-[#2c2440] cursor-pointer select-none active:opacity-100 transition-opacity"
                                >
                                    © 2026 · SHOPDIGITAL
                                </p>
                                <div className="flex items-center gap-2 sm:gap-2.5">
                                    <button
                                        ...
                                        className="text-[7px] font-extrabold uppercase tracking-[0.12em] text-[#2c2440] hover:text-[#ff6b6b] flex items-center gap-1 active:opacity-75 transition-all select-none"
                                    >
